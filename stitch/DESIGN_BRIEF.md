...
- PrismRelay Canary turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called PrismRelay Canary. It should be a small full-viewport browser game where the player routes glowing prisms across a relay grid, flips mirror/splitter nodes with keyboard or click controls, collects charge pulses, avoids overload lanes, and can open a settings overlay withou…
...
- Gameplay - PrismRelay Canary
- Game Settings - PrismRelay Canary

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - PrismRelay Canary
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - PrismRelay Canary
